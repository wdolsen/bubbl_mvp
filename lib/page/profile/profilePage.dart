    ...
    return authstate.isbusy
        ...
        : list == null || list.length < 1
            ? Container(
                ...
                child: NotifyText(
                  title: isMyProfile
                      ? 'You haven\'t ${isreply ? 'replied to any reviews' : 'posted any reviews yet'}'
                      : '${authstate.profileUserModel.userName} hasn\'t ${isreply ? 'replied to any reviews' : isMedia ? 'posted any media reviews yet' : 'posted any reviews yet'}',
                  subTitle: isMyProfile
                      ? 'Tap review button to add new'
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        ),  */ ///displays username on profile, not needed
        Padding(
